...
export default function Sidebar() {
  ...
  return (
    <div className={styles.wrapper}>
      <div
        className={`${styles.sidebar__overlay} ${styles.sidebar__overlay__hidden}`}
      ></div>
      <div className={styles.sidebar__container}>
        ...
        <div className={styles.sidebar__wrapper}>
          <div className={styles.sidebar__top}>
            ...
            >
              <div
                className={`${styles.sidebar__link__active} ${styles.sidebar__active__line}`}
              ></div>
            ...
            <Link href="/explore/library" className={styles.sidebar__link__wrapper}>
              <div
                className={`${styles.sidebar__link__active} ${styles.sidebar__active__line}`}
              ></div>
              <div className={styles.sidebar__img__wrapper}>
          ...
          <div className={styles.sidebar__bottom}>
            <Link href="/explore/settings" className={styles.sidebar__link__wrapper}>
              <div
                className={`${styles.sidebar__link__active} ${styles.sidebar__active__line}`}
              ></div>
              <div className={styles.sidebar__img__wrapper}>
            ...
            <Link href="" className={styles.sidebar__link__wrapper}>
              <div
                className={`${styles.sidebar__link__active} ${styles.sidebar__active__line}`}
              ></div>
              <div className={styles.sidebar__img__wrapper}>
              ...
              {user ? (
                <div onClick={() => logout} className={styles.sidebar__link__text}>
                  Logout
                </div>
              ) : (
                <div
